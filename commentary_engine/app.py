...
def get_gemini_model(system_instruction):
    ...
    # Using the standard gemini-2.5-flash as the "Thinking" variant may be under a different string depending on release, 
    # but flash is fast and handles instructions well. You can change this to "gemini-2.0-flash-thinking-exp" if you have access.
